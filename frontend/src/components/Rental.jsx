...
//       // Optional fields
//       if (formData.review) {
//         formDataForSubmit.append("review", formData.review);
//       }
      
//       if (formData.rating) {
//         formDataForSubmit.append("rating", formData.rating);
//       }
...
//       <h1 className="text-3xl font-bold text-[#1399c6] mb-6 text-center">
...
//             <button onClick={() => setSuccess(false)} className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded">
//               List Another Item
//             </button>
//             <button onClick={() => window.location.href = "/products"} className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">
//               View My Listings
//             </button>
//           </div>
//         </div>
...
//                   <pre className="overflow-auto p-2 bg-red-50 rounded mt-2">{errorDetails}</pre>
//                 </details>
//               )}
//             </div>
//           )}
...
//             {/* Location fields - City dropdown and Address */}
//             <select 
//               className="input" 
...
//           {/* Image Upload - Split into Main Product Image and Additional Images */}
...
//             className="bg-[#1399c6] hover:bg-[#117a9c] text-white font-bold py-2 px-6 rounded"
//           >
